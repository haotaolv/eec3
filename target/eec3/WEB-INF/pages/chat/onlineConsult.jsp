...
<head>
    ...
    <link href="../css/onlineConsult.css" rel="stylesheet">
    ...
    <div class="row ">
            ...
            <div class="row panel-left-down">
                <div class="col-md-12">
                    <textarea class="left-down-text" id="sendContent"
                              onkeydown="if(event.keyCode == 13){sendToServer();}">
                ...
                <div class="col-md-3 col-sm-4 col-xs-8 col-lg-3">
                    <div class=" panel-left-btnArea">
                        <div class=" panel-footer">
                            ...
                            <button id="send" onclick="sendToServer()" type="button" class="btn btn-primary send-btn-location">发送</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3 panel-right">
            ...
            <div class="panel-right-area ">
                <span class="panel-right-title">常见问题解答</span>
            </div>
            <%--</div>--%>
        </div><!--/.col-right-->
    </div><!--/.row-->
...
<script src="../js/onlineConsult.js"></script>
